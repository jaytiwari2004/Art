...
export default function Footer() {
  return (
    <footer className="relative bg-[#6d88c7] text-[#1a1a1a] overflow-hidden flex flex-col justify-between pt-12 md:pt-20 px-6 md:px-16 min-h-[90vh]">
      
      {/* Top Section */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 w-full max-w-[1600px] mx-auto z-10">
        
        {/* Left: Newsletter Form */}
        <div className="lg:col-span-5 flex flex-col">
          <h2
            className="text-[16px] leading-[24px] mb-6 md:mb-8"
            style={{
          ...
          <p 
            className="text-[14px] leading-[18px] md:leading-[16px] max-w-full md:max-w-[360px] mb-10 md:mb-12"
            style={{
          ...
          <form className="space-y-6 md:space-y-8 max-w-md w-full">
            ...
            <label className="flex items-start gap-4 cursor-pointer mt-6">
              ...
              >
                I consent to my information being collected in accordance with the Art privacy policy
              </p>
            </label>
        ...
        {/* Middle: Links Grid */}
        <div className="lg:col-span-7 flex flex-col md:flex-row space-y-10 md:space-y-0 md:justify-between lg:pl-24 xl:pl-32 lg:pr-16 xl:pr-24">
          <ul 
            className="flex flex-col space-y-3 font-antique text-[14px] uppercase tracking-[0.3em]"
            style={{ fontFamily: 'var(--font-antique), serif' }}
          >
      ...
      <div className="w-full flex justify-start items-end max-w-[1600px] mx-auto z-0 -mb-2 md:-mb-4 xl:-mb-8">
        <h1 
          className="pointer-events-none select-none text-[120px] sm:text-[200px] md:text-[303px] leading-[100px] sm:leading-[180px] md:leading-[303px]"
          style={{
      ...
      {/* Bottom Bar */}
      <div className="relative z-10 w-full pb-8 pt-8 px-6 md:px-16">
        <div 
          className="max-w-[1600px] mx-auto flex flex-col md:flex-row justify-between items-center opacity-80 gap-4"
          style={{
            fontFamily: "var(--font-antique), 'EB Garamond', Georgia, serif",
            fontSize: "10px",
            letterSpacing: "0.2em",
